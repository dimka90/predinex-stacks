    ...
    return (
        <div className="glass-card p-8 relative overflow-hidden animate-pulse">
            ...
            <div className="space-y-4 relative z-10">
                {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="flex items-center justify-between p-5 bg-slate-900/40 rounded-2xl border border-white/5 shadow-sm">
                        <div className="flex items-center gap-5">
                            <div className="h-5 w-5 bg-slate-800/80 rounded-md" />
