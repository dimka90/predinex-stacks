...
const ThemeToggle = () => {
    return (
        ...
        >
            ...
            <Sun className="h-5 w-5 block dark:hidden text-amber-500 group-hover:rotate-[120deg] transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] relative z-10 group-hover:drop-shadow-[0_0_15px_rgba(245,158,11,0.8)]" aria-hidden="true" />
