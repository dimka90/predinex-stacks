        ...
        <nav role="navigation" aria-label="Pagination Navigation" className="flex justify-center gap-2 mt-8">
            <Tooltip content="Previous Page" position="top">
                <button
                    ...
                    className="px-6 py-4 md:py-3 rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md hover:bg-white/10 hover:border-primary/40 focus:ring-2 focus:ring-primary/50 disabled:opacity-30 disabled:pointer-events-none transition-all font-black text-xs uppercase tracking-widest active:scale-95 shadow-inner min-w-[100px]"
                >
                    Prev
                </button>
            </Tooltip>
