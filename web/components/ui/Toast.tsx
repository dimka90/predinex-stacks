...
export default function Toast({
    ...
    return (
        <div className={`flex items-center gap-4 px-6 py-4 rounded-2xl border backdrop-blur-xl shadow-2xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] transform ${isVisible ? 'translate-x-0 opacity-100 animate-in slide-in-from-right-10 duration-700' : 'translate-x-20 opacity-0'} ${bgClasses[type]} min-w-[320px] fixed bottom-8 right-8 z-[100]`}>
